...
import com.lucas.os.services.TecnicoService;

@CrossOrigin("*") //Configuração p/ receber requisições de múltiplas fontes
@RestController //Informando que é uma classe controladora REST e irá receber requisições http
@RequestMapping(value= "/tecnicos") //setando endpoint
public class TecnicoController {
	...
	@GetMapping
	public ResponseEntity<List<TecnicoDTO>> findall(){ //Listagem de técnicos
